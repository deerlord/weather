...
FLATTEN_HOURLY = {'dt': 123456, 'temp': 0.0, 'feels_like': 0.0, 'pressure': 0.0, 'humidity': 0.0, 'dew_point': 0.0, 'clouds': 0.0, 'visibility': 0.0, 'wind_speed': 0.0, 'wind_deg': 0, 'weather': [], 'pop': 0.0, 'rain_1h': 0.0, 'rain_3h': 0.0, 'snow_1h': 0.0, 'snow_3h': 0.0}
